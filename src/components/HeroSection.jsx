    ...
    <section className="relative min-h-screen flex items-center justify-center px-4 py-20">
        ...
        >
          ...
          <div className="space-y-3 lg:space-y-4">
            <div style={{ fontFamily: 'var(--font-chakra-petch), system-ui, sans-serif' }}>
              <TypingText
                text={checkinData?.title || "O Gestor de IA do ZERO está chegando"}
          ...
          <motion.p
            ...
            style={{ fontFamily: 'var(--font-chakra-petch), system-ui, sans-serif' }}
          >
            <span className="hidden lg:inline">🎯 Confirme sua presença e garanta sua vaga no Gestor de IA do ZERO que já transformou a vida de{' '}
            <span className="text-primary font-semibold">milhares de pessoas</span></span>
            <span className="lg:hidden">🎯 Garante sua vaga no Gestor de IA do ZERO que já transformou <span className="text-primary font-semibold">milhares de vidas</span></span>
          </motion.p>
          ...
          >
            <p className="text-yellow-400 font-medium flex items-start lg:items-center gap-2 text-sm lg:text-base" style={{ fontFamily: 'var(--font-sans)' }}>
              ...
              <span>
                <strong>ATENÇÃO:</strong> <span className="hidden lg:inline">O check-in é OBRIGATÓRIO e deve ser feito até</span><span className="lg:hidden">Check-in até</span> terça-feira às 18h.
              </span>
            </p>
          </motion.div>
          ...
          >
            <div className="terminal-window">
              <div className="terminal-header">
                ...
                <span className="text-sm text-gray-400 ml-4">gestor-ia-checkin.js</span>
              </div>
              <div className="p-4 space-y-2">
                <div className="text-green-400 font-mono text-sm">
                  Iniciando Gestor de IA...
                </div>
      ...
      >
        <div className="font-mono text-sm text-primary space-y-1">
          <div>{"<ai_specialist>"}</div>
          <div className="ml-4">const future = "ai_specialist";</div>
