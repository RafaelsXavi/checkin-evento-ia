...
const CheckinSteps = memo(({ currentStep, completedSteps, userData, onStepComplete, onClose }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    codeResponse: '' // Resposta sobre o Plaud
  })
  ...
  useEffect(() => {
    if (showTimer && timerCount > 0) {
      ...
      const calendarUrl = checkinData?.calendarUrl || "https://calendar.google.com/calendar/u/0/r/eventedit?text=Gestor+de+IA+do+ZERO+-+Aula+1&details=Link+da+call:+https://us06web.zoom.us/j/87985750737?pwd=IY4s28M2H02QTVCBDOcsKFb2Nb1wF1.1&location=https://us06web.zoom.us/j/87985750737?pwd=IY4s28M2H02QTVCBDOcsKFb2Nb1wF1.1&dates=20250819T230000Z/20250820T010000Z"
  ...
  const steps = useMemo(() => [
    ...
    },
    {
      ...
      description: 'Junte-se ao grupo exclusivo do evento',
    ...
    },
    {
      id: 4,
      icon: '🧠',
      title: 'Preparar Ambiente de IA',
      description: 'Certifique-se de ter tudo pronto para trabalhar com IA',
    ...
    },
    {
      id: 6,
      icon: '🤖',
      title: 'Modelos Completos de IA',
      description: 'Tenha acesso ao Plaud completo',
      buttonText: 'Quero o Plaud',
    ...
    if (response === 'yes') {
      if (typeof fbq !== 'undefined') {
        fbq('track', 'CustomEvent', {
          ...
          content_name: 'Gravação Vitalícia Gestor de IA',
          value: 0.00,
          currency: 'BRL'
        });
      }
    ...
    if (response === 'yes') {
      if (typeof fbq !== 'undefined') {
        fbq('track', 'CustomEvent', {
          ...
          content_name: 'Plaud Gestor de IA',
          value: 0.00,
          currency: 'BRL'
        });
      }
  ...
  const StepButton = useCallback(({ step, isAccessible, isCompleted, isCurrent }) => {
    const handleStepClick = () => {
      ...
      if (step.id === 0) {
        ...
        const whatsappUrl = checkinData?.whatsappUrl || "https://sndflw.com/i/gestor-ia-do-zero-i"
      ...
      return (
        <div className="mb-4 p-6 glass-card">
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              {[
                { key: 'computer', label: 'Plaud funcionando', icon: '🤖' },
          ...
          <div className="mb-4 p-6 glass-card">
            <div className="space-y-6">
              <div className="text-center">
                ...
                <p className="text-text-muted text-sm">
                  Garanta acesso vitalício às gravações completas do Gestor de IA do ZERO
                </p>
              </div>
        ...
        return (
          <div className="mb-4 p-6 glass-card">
            <div className="space-y-6">
              <div className="text-center">
                <h4 className="text-lg font-semibold text-text-light mb-2">
                  🤖 Modelos Completos de IA
                </h4>
                <p className="text-text-muted text-sm">
                  Tenha acesso ao Plaud desenvolvido no evento
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                {codeOffer === 'yes' && (
                  <div className="mb-4">
                    ...
                    >
                      💳 Quero o Plaud (ir para checkout)
                    </a>
                  </div>
                )}
              </div>
              <div className="space-y-3" style={{ position: 'relative', zIndex: 100 }}>
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <span className="text-text-light text-sm flex-1 leading-relaxed">
                      Confirmo que quero fazer o check-in e NÃO quero aproveitar a oportunidade de ter o Plaud
                    </span>
                  </div>
                </div>
