...
const CredentialModal = ({ isOpen, onClose, credentialImage, ticketId, userName }) => {
  ...
  const shareOnLinkedIn = () => {
    const text = `🚀 Acabei de confirmar minha presença no Gestor de IA do ZERO da IAClub! 

7 dias intensivos que podem mudar minha carreira na inteligência artificial. Do zero ao primeiro emprego como especialista em IA!

#IAClub #InteligenciaArtificial #GestorIA #CarreiraTech`
    ...
    if (typeof fbq !== 'undefined') {
      fbq('track', 'CustomEvent', {
        ...
        platform: 'LinkedIn',
        ticket_id: ticketId,
        content_name: 'Check-in Gestor de IA do ZERO'
      });
    }
  }

  const shareOnTwitter = () => {
    const text = `🚀 Confirmado no Gestor de IA do ZERO da @IAClub! 

7 dias que podem mudar minha vida profissional 🤖✨

#IAClub #InteligenciaArtificial #GestorIA #Tech`
  ...
  const shareOnWhatsApp = () => {
    const text = `🚀 *Gestor de IA do ZERO - IAClub*

Acabei de confirmar minha presença no curso que pode mudar minha vida profissional!

✅ *Meu ingresso:* #IC2025-${String(ticketId).padStart(4, '0')}
🤖 *Modalidade:* 100% Online

Vem comigo nessa jornada! ${window.location.origin}`

    const url = checkinData?.whatsappUrl || `https://sndflw.com/i/gestor-ia-do-zero-i`
  ...
  const downloadImage = () => {
    if (credentialImage) {
      ...
      link.download = `iaclub-ingresso-${userName?.replace(/\s+/g, '-')?.toLowerCase() || 'participante'}.png`
          ...
          <div className="glass-card p-4 md:p-6 lg:p-8 relative bg-gradient-to-br from-background via-secondary/20 to-background border border-primary/20 shadow-2xl h-full md:h-auto flex flex-col">
            ...
            >
              ...
              >
                ...
                <span className="text-sm text-text-muted/80">
                  Sua jornada para se tornar um especialista em IA profissional começa aqui 🚀
                </span>
              </motion.p>
            </motion.div>
            ...
            >
              {credentialImage && (
                <div className="relative group">
                  <img
                    src={credentialImage}
                    alt="Credencial do Gestor de IA do ZERO"
            ...
            >
              ...
              <div className="text-center">
                <motion.button
                  onClick={() => window.open('https://calendar.google.com/calendar/u/0/r/eventedit?text=Gestor+de+IA+do+ZERO+-+Aula+1&details=Link+da+call:+https://us06web.zoom.us/j/87985750737?pwd=IY4s28M2H02QTVCBDOcsKFb2Nb1wF1.1&location=https://us06web.zoom.us/j/87985750737?pwd=IY4s28M2H02QTVCBDOcsKFb2Nb1wF1.1&dates=20250819T230000Z/20250820T010000Z', '_blank')}
                  whileHover={{ 
                    scale: 1.05,
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="glass-card p-4 bg-gradient-to-br from-pink-500/10 to-purple-500/10 border border-pink-500/20">
                      ...
                      <ul className="text-sm text-text-muted space-y-1">
                        ...
                        <li>• Use nos stories com #IAClub</li>
                        <li>• Marque @iaclub.oficial</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-card p-4 bg-gradient-to-br from-blue-500/10 to-blue-600/10 border border-blue-500/20">
                      ...
                      <ul className="text-sm text-text-muted space-y-1">
                        ...
                        <li>• Use hashtags #IAClub #Tech</li>
                        <li>• Conecte com outros especialistas</li>
                      </ul>
                    </div>
                    ...
                    <div className="glass-card p-4 bg-gradient-to-br from-gray-600/10 to-gray-800/10 border border-gray-500/20">
                      ...
                      <ul className="text-sm text-text-muted space-y-1">
                        ...
                        <li>• Use #IAClub #100DaysOfCode</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 text-center p-4 bg-primary/10 rounded-xl border border-primary/20">
                    ...
                    <p className="text-sm text-text-muted">
                      Sua credencial pode ser o empurrão que alguém precisa para mudar de vida através da inteligência artificial.
                    </p>
                  </div>
