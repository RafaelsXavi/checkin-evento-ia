...
const CheckinEditor = ({ isOpen, onClose, checkin, onSave }) => {
  ...
  const defaultLessons = [
    ...
    },
    {
      ...
      topics: [
        ...
        'Evolução significativa do nosso Plaud',
    ...
    },
    {
      ...
      day: 'QUINTA',
      date: '21 AGO',
      title: '⭐ AULA MAIS IMPORTANTE: Machine Learning + IAClub',
      time: 'Ao vivo às 20h no Zoom',
      type: 'live',
      color: 'red',
      ...
      icon: '🔥',
      topics: [
        'Machine Learning: a tecnologia de IA mais usada do mundo',
        'Deixando nosso Plaud 90% pronto e funcional',
        'Técnicas avançadas que impressionam recrutadores',
        'Tudo sobre o IAClub: sua comunidade de transformação',
    ...
    },
    {
      ...
      topics: [
        ...
        'Resolução de dúvidas técnicas do Plaud',
  ...
  const generateSlug = (title) => {
    return title
      ...
      .replace(/[^a-z0-9\s\-_]/g, '') // Permite letras, números, espaços, hífens e underscores
  ...
  const handleSlugChange = async (e) => {
    ...
    // Permitir digitação direta de hífens e underscores, apenas sanitizar caracteres perigosos
    const slug = rawValue
      .toLowerCase()
      .normalize('NFD')
      .replace(/[\u0300-\u036f]/g, '') // Remove acentos
      .replace(/[^a-z0-9\-_]/g, '') // Permite apenas letras, números, hífens e underscores
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: O Gestor de IA do ZERO está chegando"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="https://sndflw.com/i/gestor-ia-..."
                    className={`w-full px-4 py-3 bg-white/10 border rounded-lg text-text-light placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-primary/50 ${
                      ...
                      <div className="space-y-4 mb-4">
                        <div>
                          ...
                          <input
                            ...
                            placeholder="Fundamentos da IA: Seu Mapa do Tesouro"
                            className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-text-light placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-primary/50"
                          />
                        </div>
