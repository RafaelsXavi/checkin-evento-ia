  ...
  useEffect(() => {
    const fetchCheckinData = async () => {
      ...
      if (!slug) {
        ...
        setCheckinData({
          title: 'O Gestor de IA do ZERO está chegando',
          countdownDate: '2025-08-19T20:00:00',
          whatsappUrl: 'https://sndflw.com/i/gestor-ia-do-zero-i',
          calendarUrl: 'https://calendar.google.com/calendar/u/0/r/eventedit?text=Gestor+de+IA+do+ZERO+-+Aula+1&details=Link+da+call:+https://us06web.zoom.us/j/87985750737?pwd=IY4s28M2H02QTVCBDOcsKFb2Nb1wF1.1&location=https://us06web.zoom.us/j/87985750737?pwd=IY4s28M2H02QTVCBDOcsKFb2Nb1wF1.1&dates=20250819T230000Z/20250820T010000Z',
