  ...
  try {
    ...
    const mapResponse = (response, type) => {
      const mappings = {
        ...
        code: {
          'yes': 'SIM, quero os modelos de IA completos',
          'no': 'NÃO, não quero',
          'no_thanks': 'Confirmo que quero fazer o check-in e NÃO quero aproveitar a oportunidade de ter os modelos de IA completos',
          'already_purchased': 'SIM (Já garanti os modelos de IA completos)'
        }
      }
...
export const exportCheckinsToCSV = async () => {
  try {
    ...
    // Criar CSV
    let csv = 'Nome,Email,Data,Horário,Resposta Gravação,Resposta Modelos IA,Timestamp\n'
